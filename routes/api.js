...
var ISO7816 = require('../simulator/javacard/framework/ISO7816.js');
            ...
            if(!loadedCard){
                ...
                await updateCard(req, loadedCard)
                    .catch(error => {
                        ...
                        res.send({
                            'APDU': error.message,
                            'error': 'Could not update smartcard'
                        });
                    });
                if(flag){
                    res.send({
                ...
                res.send({
                    'APDU': e.message,
                    'error': 'there are some errors during the processing'
                });
            }
...
/**
 * Delete a card in the database specified by card id
 *
 * @param  {Request}       req           The request
...
/**
 * Find a card in the database specified by card id
 *
 * @param {Request}      req           The request
...
/**
 * Update a card in the database specified by card id
 *
 * @param {Request}      req           The request
 * @param {Smartcard}    LoadedCard    Currently loaded card
 *
