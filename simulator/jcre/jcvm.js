...
module.exports = {
     ...
     * University of Southampton
     */
    createInstance: async function(smartcard, capFile, params, appletRef){
        var i = capFile.COMPONENT_Applet.applets[appletRef].install_method_offset - 1;
        var opcodes = capFile.COMPONENT_Method.method_info;
        if (opcodes[i] > 127) {
            i += 4;
...
async function executeBytecode(smartcard, capFile, i, frames, currentFrame){
        ...
        case mnemonics.sreturn: //0x78
            ...
            if (invoker >= 0) {
                ...
                return new Promise(function (resolve, reject) {
                    reject(new Error('0x6999'));//'SW_APPLET_SELECT_FAILED'
                });
            } else {
                return new Promise(function (resolve, reject) {
    ...
    if(currentFrame >= 0){
        return await executeBytecode(smartcard, capFile, i, frames, currentFrame)
            .catch(error => {return new Promise(function (resolve, reject) {
                reject(error);
            });});
    } else {
 ...
 * University of Southampton
 */
async function apiError(apiresult){
